...
<head>
    ...
    <title>SARF Tracking - Branches Management</title>
...
<body>
    ...
    <div class="main">
        <header class="topbar">
            ...
            <div class="topbar-title">Branches Management</div>
        ...
        <div class="content">
            <div class="panel">
                <div class="panel-header">
                    <div class="panel-title"><i class="fas fa-building"></i> Branches List</div>
                    <div class="panel-controls">
                        ...
                        <button class="btn btn-add"><i class="fas fa-plus"></i> Add Branch</button>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="6" style="text-align: center; padding: 30px;">No branches found</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
