...
<head>
    ...
    <title>SARF Tracking - Departments Management</title>
...
<body>
    ...
    <div class="main">
        <header class="topbar">
            ...
            <div class="topbar-title">Departments Management</div>
        ...
        <div class="content">
            <div class="panel">
                <div class="panel-header">
                    <div class="panel-title"><i class="fas fa-sitemap"></i> Departments List</div>
                    <div class="panel-controls">
                        ...
                        <button class="btn btn-add"><i class="fas fa-plus"></i> Add Department</button>
                    </div>
                </div>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-muted">Main Branch</td>
                            ...
                            @empty
                            <tr>
                                <td colspan="6" style="text-align: center; padding: 30px;">No departments found</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
