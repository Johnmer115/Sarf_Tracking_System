...
<head>
    ...
    <title>SARF Tracking - SARF Reports</title>
...
<body>
    ...
    <div class="main">
        <header class="topbar">
            ...
            <div class="topbar-title">SARF Reports</div>
        ...
        <div class="content">
            <div class="panel">
                <div class="panel-header">
                    <div class="panel-title"><i class="fas fa-file-alt"></i> SARF Reports List</div>
                    <div class="panel-controls">
                        ...
                        <button class="btn btn-add"><i class="fas fa-plus"></i> New Report</button>
                    </div>
                </div>
                    ...
                    <table class="data-table">
                        <thead>
                            <tr>
                                ...
                                <th style="width:22%;">Report Title</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><div class="td-name">SARF Report {{ $user->id }}</div></td>
