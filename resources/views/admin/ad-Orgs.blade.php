...
<head>
    ...
    <title>SARF Tracking - Organizations Management</title>
...
<body>
    ...
    <div class="main">
        <header class="topbar">
            ...
            <div class="topbar-title">Organizations Management</div>
        ...
        <div class="content">
            <div class="panel">
                <div class="panel-header">
                    <div class="panel-title"><i class="fas fa-network-wired"></i> Organizations List</div>
                    <div class="panel-controls">
                        ...
                        <button class="btn btn-add"><i class="fas fa-plus"></i> Add Organization</button>
                    </div>
                </div>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-muted">Organization</td>
                                <td><span class="badge b-admin">Active</span></td>
                            ...
                            @empty
                            <tr>
                                <td colspan="6" style="text-align: center; padding: 30px;">No organizations found</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
